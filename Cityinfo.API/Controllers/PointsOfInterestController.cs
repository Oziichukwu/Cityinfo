...
namespace Cityinfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
            ...
            int cityId, int pointofinterestid)
        {
            ...
            var pointOfInterest = await _cityInfoRepository.GetPointOfInterestCityAsnc(cityId, 
                pointofinterestid);
...
;           }
            ...
            var pointOfInterestEntity = await _cityInfoRepository
                .GetPointOfInterestCityAsnc(cityId, pointOfInterestId);
            ...
            int pointOfInterestId, JsonPatchDocument<PointOfInterestForUpdateDto> patchDocument)
        {
            ...
            var pointOfInterestEntity = await _cityInfoRepository.GetPointOfInterestCityAsnc
